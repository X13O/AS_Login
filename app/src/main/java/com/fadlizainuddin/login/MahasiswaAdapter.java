...
public class MahasiswaAdapter extends RecyclerView.Adapter<MahasiswaViewHolder> {
    ...
    public MahasiswaAdapter(List<MahasiswaModel> mahasiswaModelList, Activity activity)
    {
        this._mahasiswaModelList = mahasiswaModelList;
        this._Activity = activity; // Ditambahkan agar bisa menampilkan form baru yaitu form tambah
    }
